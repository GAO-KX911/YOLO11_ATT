...
if __name__ == '__main__':
	file_path = r"/home/njust/GAO/V11/ultralytics-8.3.39/TestData/JPEGImages"  # 图片文件夹
	label_path = r'/home/njust/GAO/V11/ultralytics-8.3.39/TestData/labels'  # 标签文件夹
	new_file_path = r"/home/njust/GAO/V11/ultralytics-8.3.39/TestData/Vocdevkit"  # 新数据存放位置
